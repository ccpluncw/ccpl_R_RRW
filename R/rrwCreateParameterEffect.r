#' This  function is used to creates am rrwParemeterEffect for an rrwModelList
#'
#' Function that creates am rrwParemeterEffect for an rrwModelList.
...
#''
#' @return am rrwModelList that only contains the parameter effect input
#' @keywords rrw rrwModelList parameter effect create add effect
#' @export
#' @examples rrwCreateParameterEffect (parameter = "b", columnName = NULL, ParameterName = overallB, parameterBounds = c(100,10,0.001), df.code = NULL, GroupByVariables = NULL))
...
rrwCreateParameterEffect <- function (parameter = NULL, columnName = NULL, ParameterName = NULL, parameterBounds = c(0,0,0.001), df.code = NULL, GroupByVariables = NULL) {
    ...
    validParameters <- c("s", "b", "bcs", "Ter", "db", "da", "nSD", "vc", "rdN", "rdMean", "rdSD")
