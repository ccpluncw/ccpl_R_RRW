...
plotMeanRRWFit <- function (data, dataRtCol = "rt", dataPhitCol = "pHit",  rtFitCol = "rtFit", pHitFitCol = "pCross", correctCol = "correct", overlapCol = "overlap", condCol = NULL, numSimsToPlot = 10, plotFilename = NULL, twoPlotsPerPage = TRUE, yMinMixRT = NULL) {
